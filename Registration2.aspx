<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Registration2.aspx.cs" Inherits="Registration" %>
...
<img src="kavya1.png">
	</div><br>	<asp:LinkButton ID="LinkBtn_Home" runat="server" ForeColor="#CC0000" OnClick="LinkBtn_Home_Click">HOME</asp:LinkButton>
	<div> 
     <h1>Registration As a Donor!!!</h1>
        <br>
	</div>
	</center>
        <br>
        ...
        <asp:TextBox ID="Tb_FirstName" runat="server"></asp:TextBox>
            ...
            <label>
                Blood Group*:&nbsp; &nbsp;&nbsp;        
        <asp:DropDownList ID="DDL_BloodGroups" runat="server" Style="color: #A00000">
         ...
         <asp:TextBox ID="Tb_DOB" runat="server" TextMode="Date"></asp:TextBox>
            ...
            <label>
                Please Confirm your availablity*:&nbsp;&nbsp;
                <asp:DropDownList ID="Ddl_status" runat="server" style="color: #A00000">
